                    ...
                    <div class="cardPanel border border-secondary" style="width: 17rem;">
                        ...
                        <div class="list">
                            <ul class="list-group list-group-flush bg-dark">
                                ...
                                <li class="list-group-item"> {{$data->Cname}} </li>
                ...
                <div class="last">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-text"> <p style="color: red;">*Photograph</p> *Photograph must be enclosed with the resume.
                                Apply Procedure</h5>
                        ...
                        <div class="company-info">
                            <div class="information">
                                <h5>প্রকাশ তারিখ</h5>
                                <span>২২ মে ২০২১</span>
                                <h5>কোম্পানির তথ্যাবলী</h5>
                                ...
                                <span>ব্যবসা: Real Estate <br>Developer <br>Trading</span>
